...
class PatchNotesFragment : Fragment() {
    ...
    fun showNewFeatures() {
        ...
        val bugFixesArray = arrayOf<Int>(R.id.newFeaturesCardView1, R.id.newFeaturesCardView2, R.id.newFeaturesCardView3, R.id.newFeaturesCardView4, R.id.newFeaturesCardView5, R.id.newFeaturesCardView6, R.id.newFeaturesCardView7, R.id.newFeaturesCardView8, R.id.newFeaturesCardView9, R.id.newFeaturesCardView10, R.id.newFeaturesCardView11, R.id.newFeaturesCardView12)
        if (newFeaturesBool) {

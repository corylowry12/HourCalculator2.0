...
class TimeCardFABPositioningFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_time_card_f_a_b_positioning, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val topAppBarBackgroundColorFragment =
            view.findViewById<MaterialToolbar>(R.id.materialToolBarTimeCardFabPositioningFragment)
        ...
        val leftCardView = requireActivity().findViewById<MaterialCardView>(R.id.leftCardViewTimeCardFabPositioning)
        val middleCardView = requireActivity().findViewById<MaterialCardView>(R.id.middleTimeCardCardViewFabPositioning)
        val rightCardView = requireActivity().findViewById<MaterialCardView>(R.id.rightCardViewTimeCardFabPositioning)
        ...
        val leftRadioButton = requireActivity().findViewById<RadioButton>(R.id.leftTimeCardRadioButton)
        val middleRadioButton = requireActivity().findViewById<RadioButton>(R.id.middleTimeCardRadioButton)
        val rightRadioButton = requireActivity().findViewById<RadioButton>(R.id.rightTimeCardRadioButton)
        ...
        if (TimeCardFABPositioningData(requireContext()).loadFABPosition() == 1) {
            middleRadioButton.isChecked = true
            middleRadioButton?.jumpDrawablesToCurrentState()
        }
        if (TimeCardFABPositioningData(requireContext()).loadFABPosition() == 2) {
    ...
    fun updateCustomColor() {
        requireActivity().findViewById<CoordinatorLayout>(R.id.timeCardFabPositioningCoordinatorLayout).setBackgroundColor(Color.parseColor(CustomColorGenerator(requireContext()).generateBackgroundColor()))
        val leftCardView = requireActivity().findViewById<MaterialCardView>(R.id.leftCardViewTimeCardFabPositioning)
        val middleCardView = requireActivity().findViewById<MaterialCardView>(R.id.middleTimeCardCardViewFabPositioning)
        val rightCardView = requireActivity().findViewById<MaterialCardView>(R.id.rightCardViewTimeCardFabPositioning)
        ...
        val startButton = requireActivity().findViewById<RadioButton>(R.id.leftTimeCardRadioButton)
        val middleButton = requireActivity().findViewById<RadioButton>(R.id.middleTimeCardRadioButton)
        val rightButton = requireActivity().findViewById<RadioButton>(R.id.rightTimeCardRadioButton)
        ...
        val collapsingToolbarLayout =
            requireActivity().findViewById<CollapsingToolbarLayout>(R.id.collapsingToolbarTimeCardFabPositioningFragment)
        ...
        if (ColoredTitleBarTextData(requireContext()).loadTitleBarTextState()) {
            activity?.findViewById<CollapsingToolbarLayout>(R.id.collapsingToolbarTimeCardFabPositioningFragment)
        ...
        val topAppBarBackgroundColorFragment =
            requireActivity().findViewById<MaterialToolbar>(R.id.materialToolBarTimeCardFabPositioningFragment)
    ...
    private fun reset() {
        val leftRadioButton = view?.findViewById<RadioButton>(R.id.leftTimeCardRadioButton)
        val middleRadioButton = view?.findViewById<RadioButton>(R.id.middleTimeCardRadioButton)
        val rightRadioButton = view?.findViewById<RadioButton>(R.id.rightTimeCardRadioButton)
